...
// Color
torch::Tensor estimate_color(SparseGridSpec&, Tensor, RenderOptions&,
        Tensor, Tensor, Tensor, Tensor);
torch::Tensor differentiable_estimate_color(SparseGridSpec&, Tensor, RenderOptions&,
        Tensor, Tensor, Tensor, Tensor, Tensor&);
void add_color_grad(SparseGridSpec &, Tensor, RenderOptions&,
        Tensor, Tensor, Tensor, Tensor, GridOutputGrads&);
torch::Tensor get_mask_out(SparseGridSpec&, RenderOptions&, RaysSpec&, bool);
...
#define _REG_FUNC(funname) m.def(#funname, &funname)
  ...
  // Color
  _REG_FUNC(estimate_color);
  _REG_FUNC(differentiable_estimate_color);
  _REG_FUNC(add_color_grad);
  _REG_FUNC(get_mask_out);
