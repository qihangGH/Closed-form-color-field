...
def define_common_args(parser: argparse.ArgumentParser):
    ...
    # r'/root/shenzhen11/fqh/cf_color/data/dtu/dtu_scan24'
    r'/root/shenzhen11/fqh/cf_color/data/nerf_synthetic/mic'
                        )
    ...
    parser.add_argument('--config', '-c',
                        ...
                        # 'configs/body.json',
                        'configs/syn.json',
                        # 'configs/syn_color.json',
                        # 'configs/llff_color_metric.json',
                        # 'configs/llff.json',
                        # 'configs/dtu.json',
                        # 'configs/dtu_white.json',
                        # 'configs/dtu_cf.json',
                        # 'configs/dtu_full_grad.json',
                        # 'configs/dtu_color.json',
                        # 'configs/custom.json',
